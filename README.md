...
- [Примеры использования](#user-content-примеры-использования)
  ...
  - [Форматирование указателей (и целые числа, как указатели)](#user-content-форматирование-указателей-и-целые-числа-как-указатели)
...
2. Совместимость форматной строки с форматной строкой языков `Python` и `C++`. 
   ...
   - `'%'` - форматный символ (`Python`) - форматирование процентов. Числа с плавающей точкой умножаются на `100.0`, целые
     сохранают своё значение, после числа добавляется символ `'%'`. Форматирование производится как для спецификатора `'d'`;
   - `'n'` - форматный символ (`Python`) - форматирование с учетом системной локали (поддерживается в форматной строке, но не используется).
...
### Форматирование указателей (и целые числа, как указатели)
