...
|`'H'`|`Py`/`C++`|Форматирует число в шестнадцатеричном виде. Для данного формата в альтернативной форме к отформатированномому числу добавляется суффикс `'H'` или `'h'` (с инверсией регистра).|
|`'r'`|`-`|Форматирует число с использованием римских цифр. Ноль выводится в виде строки 'nulla', бесконечность (числа больше 8191) - в виде строки 'infinitas'. Для вывода используются латинские буквы. Можно включить использование 'Unicode'-символов для римских цифр соответствующим флагом при вызове функции форматирования.|
|`'R'`|`-`|Форматирует число с использованием римских цифр. Ноль выводится в виде строки 'NULLA', бесконечность (числа больше 8191) - в виде строки 'INFINITAS'. Для вывода используются латинские буквы. Можно включить использование 'Unicode'-символов для римских цифр соответствующим флагом при вызове функции форматирования.|
