...
использование именованного приведёт к выбросу исключения, если это не запрещено режимом игнорирования
ошибок.

**conversion** - преобразование типа аргумента, см. [далее](md_/#Преобразование#Преобразование типа аргумента).
