...
- [Примеры использования](#user-content-примеры-использования)
  - [Вызовы функций форматирования с разными типами списков аргументов](#user-content-вызовы-функций-форматирования-с-разными-типами-списков-аргументов)
...
### Вызовы функций форматирования с разными типами списков аргументов
